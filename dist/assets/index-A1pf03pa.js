(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function e(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=e(s);fetch(s.href,n)}})();class y{#t={};on(t,e){this.#t[t]||(this.#t[t]=[]),this.#t[t].push(e)}emit(t,e){this.#t[t]&&this.#t[t].forEach(i=>i(e))}}class l extends y{constructor(t,e){if(super(),this.id=t,this.title=e.title,this.content=e.content,e.savedState){const i=e.savedState;this.width=i.width,this.height=i.height,this.x=i.x,this.y=i.y,this.isMinimized=i.isMinimized,this.zIndex=i.zIndex}else this.width=e.width,this.height=e.height,this.x=Math.min(Math.max(0,Math.random()*(window.innerWidth-this.width-100)),window.innerWidth-this.width-100),this.y=Math.min(Math.max(50,Math.random()*(window.innerHeight-this.height-100)),window.innerHeight-this.height),this.isMinimized=!1;this.isDragging=!1,this.initialX=0,this.initialY=0,this.initialMouseX=0,this.initialMouseY=0,this.createElement(),this.x=Math.min(Math.max(0,this.x),Math.max(0,window.innerWidth-this.width)),this.y=Math.min(Math.max(0,this.y),Math.max(0,window.innerHeight-this.height)),this.isMinimized&&this.minimize(),window.addEventListener("resize",this.handleResize.bind(this)),this.createResizeHandles()}createElement(){this.element=document.createElement("div"),this.element.className="window",this.element.style.position="fixed",this.element.style.left=`${this.x}px`,this.element.style.top=`${this.y}px`,this.element.style.width=`${this.width}px`,this.element.style.height=`${this.height}px`,this.element.style.overflow="hidden",this.titleBar=document.createElement("div"),this.titleBar.className="window-title-bar title-bar",this.titleBar.style.cursor="move",this.titleBar.style.userSelect="none",this.titleBar.style.display="flex",this.titleBar.style.justifyContent="space-between",this.titleBar.style.alignItems="center",this.titleText=document.createElement("div"),this.titleText.className="window-title-bar-text title-bar-text",this.titleText.textContent=this.title,this.titleText.style.fontSize="13px",this.titleBar.appendChild(this.titleText);const t=document.createElement("div");t.className="title-bar-controls",t.style.display="flex",this.minimizeButton=document.createElement("button"),this.minimizeButton.className="window-minimize-button",this.minimizeButton.ariaLabel="Minimize",this.minimizeButton.onclick=e=>{e.stopPropagation(),this.toggleMinimize()},t.appendChild(this.minimizeButton),this.closeButton=document.createElement("button"),this.closeButton.className="window-close-button",this.closeButton.ariaLabel="Close",this.closeButton.onclick=e=>{e.stopPropagation(),this.emit("close",this)},t.appendChild(this.closeButton),this.titleBar.appendChild(t),this.contentArea=document.createElement("div"),this.contentArea.className="window-content window-body",this.contentArea.innerHTML=this.content,this.titleBar.onmousedown=e=>{e.preventDefault(),this.startDrag(e)},this.element.appendChild(this.titleBar),this.element.appendChild(this.contentArea),this.element.onclick=()=>this.emit("focus",this)}createResizeHandles(){[{cursor:"nwse-resize",position:"top-left",dx:-1,dy:-1},{cursor:"ns-resize",position:"top-center",dx:0,dy:-1},{cursor:"nesw-resize",position:"top-right",dx:1,dy:-1},{cursor:"ew-resize",position:"middle-left",dx:-1,dy:0},{cursor:"ew-resize",position:"middle-right",dx:1,dy:0},{cursor:"nesw-resize",position:"bottom-left",dx:-1,dy:1},{cursor:"ns-resize",position:"bottom-center",dx:0,dy:1},{cursor:"nwse-resize",position:"bottom-right",dx:1,dy:1}].forEach(e=>{const i=document.createElement("div");switch(i.className=`resize-handle resize-${e.position}`,i.style.cssText=`
    ...
    `;const s=document.createElement("div");s.className="message-sender",s.style.cssText=`
      ...
      margin-bottom: 4px;
      color: #666;
    `,s.textContent=t.username,e.appendChild(s);const n=document.createElement("div");this.parseMessageContent(t.data).forEach(c=>{const a=document.createElement("div");c.type==="code"?a.style.cssText=`
    ...
    `,e.appendChild(i),t.appendChild(e),Object.entries(this.categories).forEach(([s,n])=>{const o=document.createElement("div");o.className="emoji-category",o.style.marginBottom="20px";const r=document.createElement("h3");r.textContent=s,r.style.cssText=`
      ...
      `;const c=document.createElement("div");c.style.cssText=`
        ...
        gap: 5px;
      `,n.forEach(a=>{const d=document.createElement("button");d.textContent=a,d.style.cssText=`
          font-size: 20px;
          padding: 5px;
        ...
        `,d.onclick=()=>{this.emit("emojiSelected",{emoji:a})},c.appendChild(d)}),o.appendChild(r),o.appendChild(c),t.appendChild(o),i.focus()}),i.oninput=s=>{const n=s.target.value.toLowerCase();t.querySelectorAll(".emoji-category").forEach(r=>{const c=r.querySelectorAll("button");let a=!1;c.forEach(d=>{const m=d.textContent.toLowerCase().includes(n);d.style.display=m?"block":"none",m&&(a=!0)}),r.style.display=a?"block":"none"})},this.contentArea.appendChild(t)}}class f{constructor(){this.listeners={}}on(t,e){this.listeners[t]||(this.listeners[t]=[]),this.listeners[t].push(e)}emit(t,e){this.listeners[t]&&this.listeners[t].forEach(i=>i(e))}}class w extends f{#t=null;#i=0;#s=0;#e=!1;#n=null;#o=null;constructor({onComplete:t=null,onReset:e=null,format:i="seconds"}={}){super(),this.#n=t,this.#o=e,this.format=i}start(t){if(!t||t<=0)throw new Error("Duration must be a positive number");if(this.#t!==null)throw new Error("Timer is already running");this.#s=t*1e3,this.#i=this.#s,this.#e=!1,this.#r()}stop(){this.#t&&(clearInterval(this.#t),this.#t=null),this.#i=0,this.#e=!1}reset(t=!1){const e=this.isRunning();this.#t&&(clearInterval(this.#t),this.#t=null),this.#i=this.#s,this.#e=!1,this.#o&&this.#o(this.#s/1e3),(t||e)&&this.#r()}pause(){this.#t&&!this.#e&&(clearInterval(this.#t),this.#t=null,this.#e=!0)}resume(){this.#e&&(this.#e=!1,this.#r())}getTimeRemaining(){return Math.ceil(this.#i/1e3)}getInitialDuration(){return this.#s/1e3}isRunning(){return this.#t!==null&&!this.#e}#r(){this.#t=setInterval(()=>{if(!this.#e){this.#i=Math.max(0,this.#i-100);const t=Math.ceil(this.#i/1e3);this.emit("tick",t),this.#i<=0&&(this.stop(),this.#n&&this.#n())}},100)}}class g extends l{constructor(t,e){super(t,e),this.element.style.boxShadow=e.styles.boxShadow||"0 4px 20px rgba(0,0,0,0.15)",this.element.style.borderRadius=e.styles.borderRadius||"12px",this.element.style.border=e.styles.border||"none",this.titleBar.style.backgroundColor=e.styles.backgroundColor||"#4338ca",this.titleBar.style.borderTopLeftRadius=e.styles.borderTopLeftRadius||"12px",this.titleBar.style.borderTopRightRadius=e.styles.borderTopRightRadius||"12px",this.timer=new w({onComplete:()=>{this.element.style.transition="opacity 0.5s ease-out",this.element.style.opacity="0",setTimeout(()=>this.emit("close",this),500)},format:"seconds"}),this.timer.on("tick",r=>this.updateTitleBarDisplay(r));const i=document.createElement("div");i.style.cssText=`
      display: flex;
      flex-direction: column;
    ...
    `,s.textContent=this.getAppropriateIcon(content.type);const n=document.createElement("div");n.style.cssText=`
      ...
      margin-bottom: 10px;
      line-height: 1.5;
    `,n.innerHTML=this.content,i.appendChild(s),i.appendChild(n),this.contentArea.appendChild(i),this.element.appendChild(this.contentArea),this.timer.start(15)}getAppropriateIcon(t){return t.toLowerCase()==="win"?"🏆":t.toLowerCase()==="time"?"⏰":t.toLowerCase()==="star"?"🌟":t.toLowerCase()==="warning"?"⚠️":"ℹ️"}updateTitleBarDisplay(t){this.titletextdiv=this.titleBar.getElementsByClassName("window-title-bar-text")[0],this.titletextdiv.textContent=`Closing in ${t}s`}}class b{constructor(t,e,i){this.element=document.createElement("div"),this.element.className="desktop-icon",this.image=document.createElement("img"),this.image.src=e,this.image.alt=t,this.label=document.createElement("span"),this.label.textContent=t,this.element.appendChild(this.image),this.element.appendChild(this.label),i&&this.element.addEventListener("dblclick",i),this.element.style.cssText=`
      position: absolute;
      display: flex;
      flex-direction: column;
      align-items: center;
