(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function e(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=e(s);fetch(s.href,n)}})();class x{#t={};on(t,e){this.#t[t]||(this.#t[t]=[]),this.#t[t].push(e)}emit(t,e){this.#t[t]&&this.#t[t].forEach(i=>i(e))}}class a extends x{#t;constructor(t,e){super(),this.#t=e,this.id=t,this.width=this.#t.width,this.height=this.#t.height,this.title=this.#t.title,this.content=this.#t.content,this.zIndex=this.#t.zIndex||1,this.isMinimized=e.isMinimized||!1,this.icon=e.icon||null,this.isDragging=!1,this.isResizing=!1,this.initialX=0,this.initialY=0,this.initialMouseX=0,this.initialMouseY=0,this.x=e.x||Math.min(Math.max(0,Math.random()*(window.innerWidth-this.width-100)),window.innerWidth-this.width),this.y=e.y||Math.min(Math.max(100,Math.random()*(window.innerHeight-this.height)-100),window.innerHeight-this.height),this.#e(),this.isMinimized&&this.minimize(),window.addEventListener("resize",this.handleResize.bind(this)),this.createResizeHandles()}async#e(){this.element=document.createElement("div"),this.element.className="window",this.element.style.position="fixed",this.element.style.left=`${this.x}px`,this.element.style.top=`${this.y}px`,this.element.style.width=`${this.width}px`,this.element.style.height=`${this.height}px`,this.element.style.overflow="hidden",this.titleBar=document.createElement("div"),this.titleBar.className="window-title-bar title-bar",this.titleBar.style.cursor="move",this.titleBar.style.userSelect="none",this.titleBar.style.display="flex",this.titleBar.style.justifyContent="space-between",this.titleBar.style.padding="5px 8px",this.titleBar.style.alignItems="center",this.titleText=document.createElement("div"),this.titleText.className="window-title-bar-text title-bar-text",this.titleText.textContent=this.title,this.titleText.style.fontSize=this.#t.styles.titlebar_fontsize||"12px",this.titleBar.appendChild(this.titleText);const t=document.createElement("div");t.className="title-bar-controls",t.style.display="flex",this.minimizeButton=document.createElement("button"),this.minimizeButton.className="window-minimize-button",this.minimizeButton.ariaLabel="Minimize",this.minimizeButton.onclick=e=>{e.stopPropagation(),this.toggleMinimize()},t.appendChild(this.minimizeButton),this.closeButton=document.createElement("button"),this.closeButton.className="window-close-button",this.closeButton.ariaLabel="Close",this.closeButton.onclick=e=>{e.stopPropagation(),this.emit("close",this)},t.appendChild(this.closeButton),this.titleBar.appendChild(t),this.contentArea=document.createElement("div"),this.contentArea.className="window-content window-body",this.contentArea.innerHTML=this.content,this.titleBar.onmousedown=e=>{e.preventDefault(),this.startDrag(e)},this.element.appendChild(this.titleBar),this.element.appendChild(this.contentArea),this.element.onclick=()=>this.emit("focus",this),this.#t?.initialURL&&await this.fetchWindowContents(this.#t.initialURL)}getConfig(){return{...this.#t}}createResizeHandles(){[{cursor:"nwse-resize",position:"top-left",dx:-1,dy:-1},{cursor:"nesw-resize",position:"top-right",dx:1,dy:-1},{cursor:"nesw-resize",position:"bottom-left",dx:-1,dy:1},{cursor:"nwse-resize",position:"bottom-right",dx:1,dy:1}].forEach(e=>{const i=document.createElement("div");switch(i.className=`resize-handle resize-${e.position}`,i.style.cssText=`
    ...
    `,e.appendChild(i),t.appendChild(e),Object.entries(this.categories).forEach(([s,n])=>{const o=document.createElement("div");o.className="emoji-category",o.style.marginBottom="20px";const r=document.createElement("h3");r.textContent=s,r.style.cssText=`
      ...
      `;const h=document.createElement("div");h.style.cssText=`
        ...
        gap: 5px;
      `,n.forEach(l=>{const c=document.createElement("button");c.textContent=l,c.style.cssText=`
          font-size: 20px;
          padding: 5px;
